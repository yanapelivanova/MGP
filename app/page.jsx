      ...
      <section ref={servicesRef} className="section" id="services">
        ...
        <div className="cards">
          <article className="card">
            <img
              className="card-img fx-fade-pulse"
              src="/svc-global.png"
              alt="Global Sourcing"
            />
            ...
            <p>
              ...
              diligence, audits and sample runs to secure the best quality–cost
              ratio.
            </p>
          </article>
          ...
          <article className="card">
            <img
              className="card-img fx-fade-pulse"
              src="/svc-optim.png"
              alt="Supply-Chain Optimisation"
            />
            <h3>Supply-Chain Optimisation</h3>
            <p>
              Network design, planning and logistics flows with measurable KPI
              improvements and OTD/OTIF reliability.
            </p>
          </article>
          ...
          <article className="card">
            <img
              className="card-img fx-fade-pulse"
              src="/svc-branding.png"
              alt="Branding"
            />
            <h3>Branding</h3>
            <p>
              Naming, identity and packaging that build trust across channels
              and markets.
            </p>
          </article>
        </div>
      ...
      <section ref={contactRef} className="section" id="contact">
        ...
        <form className="contact-form" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="form-actions">
            <button className="neumorphic-btn" type="submit">
              Send
            </button>
          </div>
        </form>
        ...
        <div className="mail mail-stack">
          <div className="stack-row">
            ...
            <div>
              ...
              <a className="stack-link" href="mailto:welcome@maisongp.com">
          ...
          <div className="stack-row">
            ...
            <div>
              ...
              <a className="stack-link" href="mailto:partners@maisongp.com">
          ...
          <div className="stack-row">
            ...
            <div>
              ...
              <a className="stack-link" href="mailto:careers@maisongp.com">
