        ...
        <div className="cards">
          <article className="card">
            <div className="svc-illu-wrap">
              <img className="svc-illu" src="/svc-branding.png" alt="BRANDING" />
            </div>
            <h3>BRANDING</h3>
          ...
          <article className="card">
            <div className="svc-illu-wrap">
              <img className="svc-illu" src="/svc-optim.png" alt="ALL IN ONE" />
            </div>
            <h3>ALL IN ONE</h3>
          ...
          <article className="card">
            <div className="svc-illu-wrap">
              <img className="svc-illu" src="/svc-sourcing.png" alt="SOURCING" />
            </div>
            <h3>SOURCING</h3>
          ...
          <article className="card">
            <div className="svc-illu-wrap">
              <img className="svc-illu" src="/svc-turnkey.png" alt="CONSULTING" />
            </div>
            <h3>CONSULTING</h3>
